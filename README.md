...
To allow stale reads (followers / read replicas), please set read_replicas argument in config/config_batch.

To disable index (VIEW part of query):
```
export YDB_NO_VIEW=1
```
